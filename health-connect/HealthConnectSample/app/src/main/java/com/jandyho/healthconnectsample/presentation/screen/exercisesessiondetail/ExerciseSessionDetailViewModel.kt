...
class ExerciseSessionDetailViewModel(
    ...
    var sessionMetrics: MutableState<com.jandyho.healthconnectsample.data.ExerciseSessionData> = mutableStateOf(
        com.jandyho.healthconnectsample.data.ExerciseSessionData(uid)
    )
        private set
