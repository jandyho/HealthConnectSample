 ...
 */
package com.jandyho.healthconnectsample.presentation.screen.exercisesession
...
class ExerciseSessionViewModel(private val healthConnectManager: com.jandyho.healthconnectsample.data.HealthConnectManager) :
    ViewModel() {
