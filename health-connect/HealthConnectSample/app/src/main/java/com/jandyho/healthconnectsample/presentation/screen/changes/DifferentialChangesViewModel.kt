 ...
 */
package com.jandyho.healthconnectsample.presentation.screen.changes
...
class DifferentialChangesViewModel(private val healthConnectManager: com.jandyho.healthconnectsample.data.HealthConnectManager) :
    ViewModel() {
            ...
            tryWithPermissionsCheck {
                changesToken.value?.let { token ->
                    ...
                    healthConnectManager.getChanges(token).collect { message ->
                        when (message) {
                            is com.jandyho.healthconnectsample.data.HealthConnectManager.ChangesMessage.ChangeList -> {
                                changes.addAll(message.changes)
                            }
                            is com.jandyho.healthconnectsample.data.HealthConnectManager.ChangesMessage.NoMoreChanges -> {
